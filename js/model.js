var modelController = (function() {
  ...
  function deleteItem (type, id){
    ...
    //для поиска индекса есть метод findIndex
  ...
  function calculateTotalSum(type){
    ...
    //   return sum;
    // для функции calculateTotalSum используем метод масива reduce 
    return data.allItems[type].reduce((acc, item) => acc + item.value, 0)
